...
div.innerText = 'hi Vova, test';

// document.getElementById('test').append(div);

// - додати йому класи wrap, collapse, alpha, beta
['wrap', 'collapse', 'alpha', 'beta'].forEach((className) => div.classList.add(className))
